...
### 1.1 Load Vision Artifacts (if Vision Stage executed)
- vision-statement.md
- stakeholder-map.md

### 1.2 Load Reverse Engineering Artifacts (if brownfield)
- architecture.md
- component-inventory.md
- technology-stack.md
- dependencies.md

### 1.3 Load Requirements Analysis
...
### 1.5 Load Epic Artifacts (if Epic Stage executed)
- epics.md
- epic-dependency.md
- epic-story-map.md
...
### 3.0 Vision Stage - Already Executed or Skip?
...
- Long-term initiative (multi-quarter scope)
- Strategic initiative tied to business OKRs

**Skip IF**:
- Bug fix or minor enhancement
- Single developer project
- Clear, well-understood scope
- Short-duration task (days, not weeks)
- Internal refactoring with no stakeholder impact
...
### 3.1.1 Epic Stage - Already Executed or Skip?
**Already executed**: Move to next determination
**Not executed - Execute IF**:
- 5+ user stories exist
- Natural groupings or themes exist in stories
- Multi-release project scope
- Multiple teams or parallel work streams
- Portfolio-level tracking needed
- Stories have complex interdependencies

**Skip IF**:
- Less than 5 stories
- Linear implementation sequence
- Single cohesive feature
- Short project duration (single sprint)
- No natural story groupings
...
- [x] Vision Stage (COMPLETED/SKIPPED)
  - **Rationale**: [Why executed or skipped]
- [x] Reverse Engineering (COMPLETED/SKIPPED)
- [x] Requirements Elaboration (COMPLETED)
- [x] User Stories (COMPLETED/SKIPPED)
- [x] Epic Stage (COMPLETED/SKIPPED)
  - **Rationale**: [Why executed or skipped]
- [x] Workflow Planning (IN PROGRESS)
- [x] Backlog Initialized (LIVING)
...
## Step 7.1: Initialize Product Backlog (LIVING ARTIFACT)

**MANDATORY**: Initialize the product backlog as a living artifact that will be updated at every approval gate.

See `backlog-management.md` for detailed backlog management instructions.
...
### Initialize product-backlog.md
- Add all user stories (if executed) with priorities
- Add all epics (if Epic Stage executed) as parent items
- Set initial status to "New" or "Ready"
- Apply prioritization (MoSCoW or custom)

### Initialize release-plan.md
- Define release scope based on epics/stories
- Document release goals
- Identify dependencies and risks

### Sync with Jira (if available)
If Jira MCP is available:
- Create initial backlog items in Jira
- Sync epic-story relationships
- Log sync status in `jira-sync-log.md`

**Note**: The backlog is a LIVING artifact - it will be updated at every subsequent approval gate throughout the workflow.
...
- [x] Vision Stage (if applicable)
- [x] Reverse Engineering (if applicable)
- [x] Requirements Analysis
- [x] User Stories (if applicable)
- [x] Epic Stage (if applicable)
- [x] Workflow Planning
- [x] Backlog Initialized (LIVING)
- [ ] Application Design - [EXECUTE/SKIP]
- [ ] Units Planning - [EXECUTE/SKIP]
...
## Backlog Status
- **Total Items**: [Count]
- **By Priority**: P1:[X], P2:[Y], P3:[Z], P4:[W]
