...
### Welcome Message
At workflow start, display the welcome message from `aidlc-rule-details/common/welcome-message.md` ONCE.

### Question Format
All questions MUST be placed in dedicated .md files, NEVER in chat. See `aidlc-rule-details/common/question-format-guide.md`.

### Content Validation
Before creating ANY file, validate content per `aidlc-rule-details/common/content-validation.md`:
...
**Detailed steps**: See `aidlc-rule-details/inception/workspace-detection.md`
...
**Detailed steps**: See `aidlc-rule-details/inception/reverse-engineering.md`
...
**Detailed steps**: See `aidlc-rule-details/inception/requirements-analysis.md`
...
**Detailed steps**: See `aidlc-rule-details/inception/user-stories.md`
...
**Detailed steps**: See `aidlc-rule-details/inception/workflow-planning.md`
...
**Detailed steps**: See `aidlc-rule-details/inception/application-design.md`
...
**Detailed steps**: See `aidlc-rule-details/inception/units-generation.md`
...
**Detailed steps**: See `aidlc-rule-details/construction/functional-design.md`
...
**Detailed steps**: See `aidlc-rule-details/construction/nfr-requirements.md`
...
**Detailed steps**: See `aidlc-rule-details/construction/nfr-design.md`
...
**Detailed steps**: See `aidlc-rule-details/construction/infrastructure-design.md`
...
**Detailed steps**: See `aidlc-rule-details/construction/code-generation.md`
...
**Detailed steps**: See `aidlc-rule-details/construction/build-and-test.md`
...
- `aidlc-rule-details/common/process-overview.md` - Workflow overview
- `aidlc-rule-details/common/session-continuity.md` - Session resumption guidance
- `aidlc-rule-details/common/content-validation.md` - Content validation requirements
- `aidlc-rule-details/common/question-format-guide.md` - Question formatting rules
- `aidlc-rule-details/common/welcome-message.md` - Welcome message to display
- `aidlc-rule-details/common/error-handling.md` - Error recovery procedures
- `aidlc-rule-details/common/terminology.md` - Term definitions
- `aidlc-rule-details/common/depth-levels.md` - Adaptive depth explanation
- `aidlc-rule-details/common/workflow-changes.md` - Mid-workflow change handling

## Inception Phase Rules
- `aidlc-rule-details/inception/workspace-detection.md`
- `aidlc-rule-details/inception/reverse-engineering.md`
