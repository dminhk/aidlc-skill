...
Start your request with **"Using AI-DLC, ..."** to activate this workflow.
...
When user requests software development with "Using AI-DLC", ALWAYS follow this workflow FIRST.
...
### Welcome Message
At workflow start, display the welcome message from `aidlc-agile-rule-details/common/welcome-message.md` ONCE.

### Question Format
All questions MUST be placed in dedicated .md files, NEVER in chat. See `aidlc-agile-rule-details/common/question-format-guide.md`.

### Content Validation
Before creating ANY file, validate content per `aidlc-agile-rule-details/common/content-validation.md`:
...
- See `aidlc-agile-rule-details/integrations/jira-integration.md`
...
**Detailed steps**: See `aidlc-agile-rule-details/inception/workspace-detection.md`
...
**Detailed steps**: See `aidlc-agile-rule-details/inception/vision-stage.md`
...
**Detailed steps**: See `aidlc-agile-rule-details/inception/reverse-engineering.md`
...
**Detailed steps**: See `aidlc-agile-rule-details/inception/requirements-analysis.md`
...
**Detailed steps**: See `aidlc-agile-rule-details/inception/user-stories.md`
...
**Detailed steps**: See `aidlc-agile-rule-details/inception/epic-stage.md`
...
**Detailed steps**: See `aidlc-agile-rule-details/inception/workflow-planning.md` and `aidlc-agile-rule-details/inception/backlog-management.md`
...
**Detailed steps**: See `aidlc-agile-rule-details/inception/application-design.md`
...
**Detailed steps**: See `aidlc-agile-rule-details/inception/units-generation.md`
...
**Detailed steps**: See `aidlc-agile-rule-details/construction/functional-design.md`
...
**Detailed steps**: See `aidlc-agile-rule-details/construction/nfr-requirements.md`
...
**Detailed steps**: See `aidlc-agile-rule-details/construction/nfr-design.md`
...
**Detailed steps**: See `aidlc-agile-rule-details/construction/infrastructure-design.md`
...
**Detailed steps**: See `aidlc-agile-rule-details/construction/code-generation.md`
...
**Detailed steps**: See `aidlc-agile-rule-details/construction/build-and-test.md`
...
- `aidlc-agile-rule-details/common/process-overview.md` - Workflow overview
- `aidlc-agile-rule-details/common/session-continuity.md` - Session resumption guidance
- `aidlc-agile-rule-details/common/content-validation.md` - Content validation requirements
- `aidlc-agile-rule-details/common/question-format-guide.md` - Question formatting rules
- `aidlc-agile-rule-details/common/welcome-message.md` - Welcome message to display
- `aidlc-agile-rule-details/common/error-handling.md` - Error recovery procedures
- `aidlc-agile-rule-details/common/terminology.md` - Term definitions
- `aidlc-agile-rule-details/common/depth-levels.md` - Adaptive depth explanation
- `aidlc-agile-rule-details/common/workflow-changes.md` - Mid-workflow change handling

## Inception Phase Rules
- `aidlc-agile-rule-details/inception/workspace-detection.md`
- `aidlc-agile-rule-details/inception/vision-stage.md` - NEW
- `aidlc-agile-rule-details/inception/reverse-engineering.md`
- `aidlc-agile-rule-details/inception/requirements-analysis.md`
- `aidlc-agile-rule-details/inception/user-stories.md`
- `aidlc-agile-rule-details/inception/epic-stage.md` - NEW
- `aidlc-agile-rule-details/inception/workflow-planning.md`
- `aidlc-agile-rule-details/inception/backlog-management.md` - NEW
- `aidlc-agile-rule-details/inception/application-design.md`
- `aidlc-agile-rule-details/inception/units-generation.md`

## Construction Phase Rules
- `aidlc-agile-rule-details/construction/functional-design.md`
- `aidlc-agile-rule-details/construction/nfr-requirements.md`
- `aidlc-agile-rule-details/construction/nfr-design.md`
- `aidlc-agile-rule-details/construction/infrastructure-design.md`
- `aidlc-agile-rule-details/construction/code-generation.md`
- `aidlc-agile-rule-details/construction/build-and-test.md`

## Integration Rules
- `aidlc-agile-rule-details/integrations/jira-integration.md` - NEW
